--1번 문제
create table Chemical_inventory_status(
    chemical_name varchar2(30),
    inventory_kg number(3),
    min_inventory_kg number(3),
    date_of_receipt date
);
insert into chemical_inventory_status (chemical_name, inventory_kg, min_inventory_kg, date_of_receipt)
values('아세트산', 500, 100, '2023-03-15');
insert into chemical_inventory_status (chemical_name, inventory_kg, min_inventory_kg, date_of_receipt)
values('수산화나트륨', 300, 50, '2023-04-20');
insert into chemical_inventory_status (chemical_name, inventory_kg, min_inventory_kg, date_of_receipt)
values('황산', 200, 80, '2023-05-10');
insert into chemical_inventory_status (chemical_name, inventory_kg, min_inventory_kg, date_of_receipt)
values('염화칼슘', 400, 120, '2023-06-05');
insert into chemical_inventory_status (chemical_name, inventory_kg, min_inventory_kg, date_of_receipt)
values('염산', 600, 200, '2023-07-08');

select * from chemical_inventory_status;
--2번 문제
create table Book_loan_records(
...
insert into book_loan_records (book_name, author, loan_date, return_due_date, actual_return_date,late_fees)
values('죄와 벌', '톨스토이', '2023-03-01', '2023-03-15', '2023-03-20', 500);
insert into book_loan_records (book_name, author, loan_date, return_due_date, actual_return_date,late_fees)
values('해리포터와 마법사의 돌', 'J.K.롤링', '2023-04-10', '2023-04-24', '2023-04-23', 0);
insert into book_loan_records (book_name, author, loan_date, return_due_date, actual_return_date,late_fees)
values('반지의 제왕', 'J.R.R.톨킨', '2023-05-15', '2023-05-29', '2023-05-29', 0);
insert into book_loan_records (book_name, author, loan_date, return_due_date, actual_return_date,late_fees)
values('빨간 머리 앤', 'L.M.몽고메리', '2023-06-20', '2023-07-04',null,null);
insert into book_loan_records (book_name, author, loan_date, return_due_date, actual_return_date,late_fees)
values('산삼', '박완서', '2023-07-10', '2023-07-24',null,null);

select * from book_loan_records;
...
create table customer_order_record(
    ...
    order_amount number(7)
);
insert into customer_order_record(order_number, customer_name, order_date, product_name, quantity, product_price, order_amount)
values(2023001, '홍길동', '2023-03-05', '노트북', 01, 1200000, 1200000);
insert into customer_order_record(order_number, customer_name, order_date, product_name, quantity, product_price, order_amount)
values(2023002, '김영희', '2023-03-08', '스마트폰', 2, 800000, 1600000);
insert into customer_order_record(order_number, customer_name, order_date, product_name, quantity, product_price, order_amount)
values(2023003, '박철수', '2023-03-15', '헤드폰', 3, 150000, 450000);
insert into customer_order_record(order_number, customer_name, order_date, product_name, quantity, product_price, order_amount)
values(2023004, '이지훈', '2023-03-20', '마우스', 1, 30000, 30000);
insert into customer_order_record(order_number, customer_name, order_date, product_name, quantity, product_price, order_amount)
values(2023005, '김민지', '2023-03-25', '키보드', 1, 50000, 50000);

select * from customer_order_record;

--4번 문제
drop table baseball;
create table baseball(
    team varchar(30),
    opposing_team varchar(30),
    match_date timestamp,
    stadium varchar(30),
    home_team_score number(2),
    opposing_team_score number(2),
    home_team_bowler varchar(30),
    opposig_team_bowler varchar(30),
    game_result varchar(20),
    broadcasting_company varchar(50),
    provider varchar(50)
);
insert into baseball(team, opposing_team, match_date, stadium, home_team_score, opposing_team_score,
home_team_bowler, opposig_team_bowler, game_result, broadcasting_company, provider)
values('LG 트윈스', 'KT wiz', '2023-07-26 18:30', '수원 kt 위즈파크', 3,4,'고우석', '손동현', '패','KBS_N_SPORTS', '네이버스포츠');
insert into baseball(team, opposing_team, match_date, stadium, home_team_score, opposing_team_score,
home_team_bowler, opposig_team_bowler, game_result, broadcasting_company, provider)
values('KT wiz', 'LG 트윈스', '2023-07-26 18:30', '수원 kt 위즈파크', 4,3,'손동현', '고우석', '승','KBS_N_SPORTS', '네이버스포츠');
...
insert into album(song_title, group_name, rekease_date, genre, publisher, agency)
values('NewJeans 2nd EP Ge Up', 'Newjeans', '2023_07-21', '댄스','YG pLUS', 'ADOR');
